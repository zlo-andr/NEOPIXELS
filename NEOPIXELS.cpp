...
void GPIO_WriteBit(GPIO_TypeDef *neopixel_gpio_typedef, uint16_t neopixel_gpio_pin, BitAction BitVal)
{
    if(BitVal != Bit_RESET)
{
neopixel_gpio_typedef->BSHR = neopixel_gpio_pin;
}
else
{
neopixel_gpio_typedef->BCR = neopixel_gpio_pin;
}
}
